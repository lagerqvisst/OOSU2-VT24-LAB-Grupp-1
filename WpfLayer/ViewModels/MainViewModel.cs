...
namespace WpfLayer.ViewModels
{
    ...
    {
        //Kontrollerklass för att returnera användarobjekt baserat på inloggningsuppgifterna i vyn

        private LoginController loginController = new LoginController();
        private DoctorController doctorController = new DoctorController();

        //Privata properties som är bundna i XAML
        ...
        //Konstruktor där commands initieras.
        ...
        private void SignIn()
        {
            ...
            //Om användaren är en doktor eller receptionist öppnas en ny vy för respektive användare.
            if (user != null)
            {
        ...
        //Andra metoder för navigation i vyn.
        ...
        //Auto genererar inloggningsuppgifter för doktorer.
        ...
        //Auto generera inloggningsuppgifter för receptionister.
        ...
        //Easter egg fun fact of the day :D
